...
@Component({
  selector: 'app-busicards',
  templateUrl: './busicards.component.html',
  styleUrls: ['./busicards.component.scss'],
  animations: [
...
export class BusicardsComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.galleryOptions = [
      ...
      ,{ "breakpoint": 823, "width": "100%", "height": "500px", "thumbnailsColumns": 1, "thumbnailsRows": 2, },
